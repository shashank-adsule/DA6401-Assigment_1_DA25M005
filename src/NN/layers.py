...
class Linear:
    ...
    def __init__(self, n_in, n_out,
        ...
        self.is_output = True if activation == "softmax" else False
        ...
        # gradients (checked by autograder)
    ...
    def backward(self, delta):
        ...
        # L2 regularization (only for weights)
    ...
    def __repr__(self):
        return (f"Linear({self.n_in} → {self.n_out}, "
                f"act={self.activation.__class__.__name__}, "
...
if __name__ == "__main__":
    ...
    output = Linear(16, 3, activation="softmax", init="xavier")
